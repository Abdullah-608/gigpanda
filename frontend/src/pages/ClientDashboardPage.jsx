...
import { Star, MessageSquare, Briefcase, BookmarkIcon, BellIcon, User, Menu } from "lucide-react";
									...
									<div className="flex items-center space-x-3">
										...
										<div className="flex-1 min-w-0">
											...
											<div className="flex items-center mt-1">
												<div className="flex">
													{[...Array(5)].map((_, i) => (
														<Star key={i} className={`h-3 w-3 ${i < 4 ? 'text-yellow-400' : 'text-gray-300'}`} />
													))}
												</div>
									...
									<div className="flex items-center space-x-3">
										...
										<div className="flex-1 min-w-0">
											...
											<div className="flex items-center mt-1">
												<div className="flex">
													{[...Array(5)].map((_, i) => (
														<Star key={i} className={`h-3 w-3 ${i < 5 ? 'text-yellow-400' : 'text-gray-300'}`} />
													))}
												</div>
